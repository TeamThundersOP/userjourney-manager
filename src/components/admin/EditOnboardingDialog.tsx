...
const EditOnboardingDialog = ({
  ...
  const updatePhase0 = (updates: Partial<typeof onboarding.phase0>) => {
    setOnboarding(prev => ({
      ...prev,
  ...
  const updatePhase1 = (updates: Partial<typeof onboarding.phase1>) => {
    setOnboarding(prev => ({
      ...prev,
  ...
  const updatePhase2 = (updates: Partial<typeof onboarding.phase2>) => {
    setOnboarding(prev => ({
      ...prev,
      ...
      <DialogContent className="sm:max-w-[600px] h-[90vh] flex flex-col">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col flex-1">
          <div className="flex-1 overflow-y-auto px-6 py-4 space-y-6">
            <Phase0Form phase0={onboarding.phase0} onUpdate={updatePhase0} />
            
            {user.onboarding?.approvals.phase0 && (
              <Phase1Form phase1={onboarding.phase1} onUpdate={updatePhase1} />
            )}
            
            {user.onboarding?.approvals.phase1 && (
              <Phase2Form phase2={onboarding.phase2} onUpdate={updatePhase2} />
            )}
          </div>
          <DialogFooter className="sticky bottom-0 bg-white py-4 mt-auto">
